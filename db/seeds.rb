...
Doctor.create! user_id: 3, name: 'lanaya', start_at: '08:00'.to_datetime, end_at: '20:00'.to_datetime
Doctor.create! user_id: 4, name: 'barratum', start_at: '10:00'.to_datetime, end_at: '17:00'.to_datetime
